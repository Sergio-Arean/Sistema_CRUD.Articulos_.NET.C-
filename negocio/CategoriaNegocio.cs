...
namespace negocio
{
    public class CategoriaNegocio
    {
        ...
        //metodo listar categoria, devuelve.. un list del objeto categoria que sera
        //el data source del respectivo combobox

        //CONSULTA SQL PROBADA OK: SELECT Id, Descripcion FROM CATEGORIAS;
        ...
        public List <string> listarNombres()
        {
            ...
            //Consulta SQL : SELECT Descripcion FROM CATEGORIAS; 
            acceso = new AccesoDatos();
